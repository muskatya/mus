...
pub enum TokenKind {
    ...
    Integer(i64), Float(f64), Character(char), String(String), Identifier(String),
    I64, I32, I16, I8, U64, U32, U16, U8, F64, F32, Bool, Char, Str, Void,
    Pub, Fn, Import, Extern, Var, Const, Return, If, Else, Or, And, As, While, For, In, Continue, Break, True, False,
    EOF
}
...
impl TokenKind {
    pub fn is_type(&self) -> bool {
        matches!(
            self, Self::I64 | Self::I32 | Self::I16 | Self::I8 |
